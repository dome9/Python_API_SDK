...
if __name__ == '__main__':
	...
	parser.add_argument('--awsAllowReadOnly',       required=False, type=bool, default=False,   choices=OnBoardingCloudAccount.AWS_ALLOW_READONLY, help='Default=True, set to True for Read-Only, and False for Full Protection')
	parser.add_argument('--awsFullProtection',      required=False, type=bool, default=False,  choices=OnBoardingCloudAccount.AWS_FULL_PROTECTION, help='Default=False, set to True for to set the Security Groups in the account to Full-Protection in the course of onboarding, or False to leave them unchanged')
